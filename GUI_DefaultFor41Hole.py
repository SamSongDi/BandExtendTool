...
startband1=1
Band1Fixed=[ [680,58],[681,58]]
startband2=16
Band2Fixed=[[37,19],[401,87],[402,87],[408,91],[409,92],[415,93],[416,93],[442,89],[443,89],[469,85],[470,85],[544,71],[545,71],[561,71],[562,71],[578,69],[579,69],[595,67],[596,67],[612,67],[613,67],[629,65],[630,65],[646,63],[647,63],[663,61],[664,61],[680,59],[681,59]]
...
class MyMplCanvas(FigureCanvas):
    ...
    def DisplaySwitch_Init(self):
        ...
        csvpath = './DataFile/mirrortaperholecavity_r0.25_r0.1.csv'
...
params = [
    ...
    {'name': 'Parameter Input', 'type': 'group', 'children': [
        {'name': 'NHole', 'type': 'int', 'value': 41, 'step': 1},
        {'name': 'Period', 'type': 'int', 'value': 34, 'step': 1},
        {'name': 'BandNum', 'type': 'int', 'value': 150, 'step': 1},
        {'name': 'CSV File Path', 'type': 'str',
            'value': './DataFile/mirrortaperholecavity_r0.25_r0.1.csv'},
    ...
    {'name': 'Point Edit', 'type': 'group', 'children': [
        {'name': 'Fixed Point-First Band', 'type': 'text', 'value': ' [680,58],[681,58]'},
        {'name': 'Fixed Point-Second Band', 'type': 'text', 'value': '[37,19],[401,87],[402,87],[408,91],[409,92],[415,93],[416,93],[442,89],[443,89],[469,85],[470,85],[544,71],[545,71],[561,71],[562,71],[578,69],[579,69],[595,67],[596,67],[612,67],[613,67],[629,65],[630,65],[646,63],[647,63],[663,61],[664,61],[680,59],[681,59]'},#!!!!!!!
    ]},
